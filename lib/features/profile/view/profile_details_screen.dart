...
import 'package:kalicart/features/profile/view/save_profile_screen.dart';
            ...
            Padding(
              ...
              child: PrimaryButton(
                onPressed: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const  SaveProfileScreen(),));
                },
